...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks =   -2201.925865354567; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -2048.3339717792696; // x position of the perpendicular encoder (in tick units)
    }
