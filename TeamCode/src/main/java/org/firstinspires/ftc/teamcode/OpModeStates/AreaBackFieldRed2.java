...
//
//@Autonomous
//public class AreaBackFieldRed2 extends LinearOpMode {
...
//                    .lineToSplineHeading(new Pose2d(9, -33.5, Math.toRadians(90)))
//                    .build();
//        }
//        else if (conePos == 3) {
//            dropPurpleSpike = drive.trajectorySequenceBuilder(startPose)
//                    .lineToLinearHeading(new Pose2d(38.5, -33, Math.toRadians(180)))
//                    .build();
//        }
//        else {//left
//            dropPurpleSpike = drive.trajectorySequenceBuilder(startPose)
//                    .lineToSplineHeading(new Pose2d(12, -50, Math.toRadians(100)))
//                    .lineToSplineHeading(new Pose2d(12, -35, Math.toRadians(150)))
//                    .build();
//        }
//
...
//                    .lineToSplineHeading(new Pose2d(49, -38.5, Math.toRadians(180)))
//                    .build();
//        }
//        else if (conePos == 3) {
//            goToBackdrop2 = drive.trajectorySequenceBuilder(goToBackdrop.end())
//                    .setVelConstraint((v, pose2d, pose2d1, pose2d2) -> 45)
//                    .setAccelConstraint((v, pose2d, pose2d1, pose2d2) -> 45)
//                    .lineToSplineHeading(new Pose2d(49, -44, Math.toRadians(180)))
//                    .build();
//        }
//        else {//left
//            goToBackdrop2 = drive.trajectorySequenceBuilder(goToBackdrop.end())
//                    .setVelConstraint((v, pose2d, pose2d1, pose2d2) -> 45)
//                    .setAccelConstraint((v, pose2d, pose2d1, pose2d2) -> 45)
//                    .lineToSplineHeading(new Pose2d(49, -32, Math.toRadians(180)))
//                    .build();
//        }
//
...
//                .lineToSplineHeading(new Pose2d(-60.5, -10.5, Math.toRadians(170)))
//                .build();
//
//        TrajectorySequence goToStage;
//        if (conePos == 1 || conePos == 2) {
...
//            sleep(1000);
//
//            drive.setPoseEstimate(new Pose2d(35.8, -32.84, drive.getPoseEstimate().getHeading()));
//
...
//            intake.flipClawUp();
//
//            drive.followTrajectorySequence(goPark);
//        }
//
//    }
//
