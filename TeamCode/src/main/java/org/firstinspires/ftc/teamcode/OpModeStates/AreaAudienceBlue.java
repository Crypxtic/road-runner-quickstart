...
//
//@Autonomous
//public class AreaAudienceBlue extends LinearOpMode {
...
//        else if (conePos == 1){
//            dropPurpleSpike = drive.trajectorySequenceBuilder(goToStackTag.end())
//                    .lineToSplineHeading(new Pose2d(-37.5, 30, Math.toRadians(0)))
//                    .addDisplacementMarker(() -> {
//                        intake.openWideClawL();
//                        sleep(500);
//                    })
//                    .lineToSplineHeading(new Pose2d(-42, 34, Math.toRadians(0)))
//                    .build();
//        }
//        else {
//            dropPurpleSpike = drive.trajectorySequenceBuilder(goToStackTag.end())
//                    .lineToLinearHeading(new Pose2d(-47, 20, Math.toRadians(-270)))
//                    .build();
//        }
//
...
//                .lineToSplineHeading(new Pose2d(-61, 12, Math.toRadians(170)))
//                .addTemporalMarker(0, ()->{
//                    intake.flipToStack();
//                })
//                .build();
...
//                .lineToSplineHeading(new Pose2d(25, 10.5, Math.toRadians(180)))
//                .lineToSplineHeading(new Pose2d(35, 16, Math.toRadians(-150)))
//                .addTemporalMarker(1, () -> {
//                    intake.flipClawUp();
//                })
//                .build();
...
//                    .lineToSplineHeading(new Pose2d(47, 35, Math.toRadians(180)))
//                    .build();
//        }
//        else if (conePos == 1) {
//            goToBackdrop2 = drive.trajectorySequenceBuilder(goToBackdrop.end())
//                    .lineToSplineHeading(new Pose2d(47, 40.5, Math.toRadians(-175)))
//                    .build();
//        }
//        else {//left
//            goToBackdrop2 = drive.trajectorySequenceBuilder(goToBackdrop.end())
//                    .lineToSplineHeading(new Pose2d(47, 30, Math.toRadians(180)))
//                    .build();
//        }
//
...
//                    .lineToSplineHeading(new Pose2d(47, 40, Math.toRadians(180)))
//                    .build();
//        }
//        else {
//            goToBackdrop3 = drive.trajectorySequenceBuilder(goToBackdrop2.end())
//                    .lineToSplineHeading(new Pose2d(47, 39, Math.toRadians(180)))
//                    .build();
//        }
//
...
//            sleep(1500);
//
//            drive.setPoseEstimate(new Pose2d(33.5, 22.5, drive.getPoseEstimate().getHeading()));
//
