...
//
        ...
        trajectoryAction1Back = drive.actionBuilder(new Pose2d(39, 35, Math.toRadians(180)))
                .strafeToSplineHeading(new Vector2d(47, 41.5), Math.toRadians(180), new TranslationalVelConstraint(45), new ProfileAccelConstraint(-45, 45))
                ...
                .splineToConstantHeading(new Vector2d(25, 9.2), Math.toRadians(180))
                .strafeToSplineHeading(new Vector2d(-50, 9.2), Math.toRadians(180))
                .afterDisp(0, new ParallelAction(
                        autoActions.armToStack(),
                        new InstantAction(() -> intake.flipToStack())
                ))
                .strafeToSplineHeading(new Vector2d(-62.5, 8.2), Math.toRadians(180), new TranslationalVelConstraint(20), new ProfileAccelConstraint(-20, 20))
                .build();

        trajectoryAction2Back = drive.actionBuilder(new Pose2d(39, 35, Math.toRadians(180)))
                .strafeToSplineHeading(new Vector2d(47, 32.5), Math.toRadians(180), new TranslationalVelConstraint(45), new ProfileAccelConstraint(-45, 45))
                .afterDisp(0, new ParallelAction(
                        autoActions.openWideClawR()
                ))
                .strafeToSplineHeading(new Vector2d(45, 33.5), Math.toRadians(180))
                ...
                .splineToConstantHeading(new Vector2d(25, 9.2), Math.toRadians(180))
                .strafeToSplineHeading(new Vector2d(-53, 9.2), Math.toRadians(180))
                .afterDisp(0, new ParallelAction(
                        autoActions.armToStack(),
                        new InstantAction(() -> intake.flipToStack())
                ))
        ...
        trajectoryAction3Back = drive.actionBuilder(new Pose2d(39, 35, Math.toRadians(180)))
                .strafeToSplineHeading(new Vector2d(47, 25), Math.toRadians(180), new TranslationalVelConstraint(45), new ProfileAccelConstraint(-45, 45))
                .afterDisp(0, new ParallelAction(
                        autoActions.openWideClawR()
                ))
                .strafeToSplineHeading(new Vector2d(45, 33.5), Math.toRadians(180))
        ...
        Action trajectoryAction1Truss = drive.actionBuilder(new Pose2d(39, 35, Math.toRadians(180)))
                ...
                .endTrajectory()
                .strafeToSplineHeading(new Vector2d(-30, 58), Math.toRadians(180))
                .afterDisp(0.8, new ParallelAction(
                                new InstantAction(() -> intake.flipToStack()),
                                autoActions.armToStack(),
                                autoActions.openWideClawL(),
        ...
        Action goToStageTruss = drive.actionBuilder(new Pose2d(-61, 38, Math.toRadians(180)))
                ...
                .splineToConstantHeading(new Vector2d(46.5, 40), Math.toRadians(45))
                .build();
        ...
        Action dropStageTruss = drive.actionBuilder(new Pose2d(-61, 38, Math.toRadians(180)))
                ...
                .strafeToSplineHeading(new Vector2d(-61, 37), Math.toRadians(180), new TranslationalVelConstraint(20), new ProfileAccelConstraint(-20, 20))
                .build();
        ...
        Action dropStage = drive.actionBuilder(new Pose2d(-62.5, 10, Math.toRadians(180)))
...
//                        autoActions.liftSlides()
                ...
                .strafeToSplineHeading(new Vector2d(40, 9.2), Math.toRadians(180))
                .afterDisp(0, new ParallelAction(
...
//                        autoActions.liftSlides()
                ...
                .splineToConstantHeading(new Vector2d(47, 28), Math.toRadians(45))
                .build();

        goToStack2Cycle = drive.actionBuilder(new Pose2d(47, 28, Math.toRadians(180)))
                        .strafeToSplineHeading(new Vector2d(46, 23), Math.toRadians(180))
                        .afterDisp(0.8, new ParallelAction(
                                autoActions.openWideClawL(),
                                autoActions.openWideClawR()
                        ))
...
//                        autoActions.liftSlides()
                ...
                .splineToConstantHeading(new Vector2d(47, 29), Math.toRadians(60))
                .build();

        Action dropStageCycle2 = drive.actionBuilder(new Pose2d(-62.5, 10, Math.toRadians(180)))
                .afterTime(1.5, new ParallelAction(
                        autoActions.raiseArmFaceUp(),
                        new InstantAction(() -> slides.resetLiftEncoder())
//                        autoActions.liftSlides()
...
//        Actions.runBlocking(claw.closeClaw());
        ...
        drive.pose = new Pose2d(37, 35, drive.pose.heading.toDouble());
