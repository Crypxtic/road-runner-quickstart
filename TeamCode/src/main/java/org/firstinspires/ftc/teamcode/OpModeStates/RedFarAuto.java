...
//
        ...
        trajectoryAction3 = drive.actionBuilder(new Pose2d(-35, -62, Math.toRadians(90)))
                .splineToLinearHeading(new Pose2d(-33, -35, Math.toRadians(30)), Math.toRadians(30))
                .build();
        ...
        trajectoryAction1 = drive.actionBuilder(new Pose2d(-35, -62, Math.toRadians(90)))
                .strafeToSplineHeading(new Vector2d(-44.5, -35), Math.toRadians(90))
                .build();
        ...
        trajectoryAction3Back = drive.actionBuilder(new Pose2d(39, -35, Math.toRadians(180)))
                .strafeToSplineHeading(new Vector2d(48, -44.5), Math.toRadians(175), new TranslationalVelConstraint(45), new ProfileAccelConstraint(-45, 45))
        ...
        trajectoryAction2Back = drive.actionBuilder(new Pose2d(39, -35, Math.toRadians(180)))
                .strafeToSplineHeading(new Vector2d(48, -39), Math.toRadians(180), new TranslationalVelConstraint(45), new ProfileAccelConstraint(-45, 45))
                .afterDisp(0, new ParallelAction(
                        autoActions.openWideClawR(),
                        autoActions.openWideClawL()
                ))
        ...
        trajectoryAction1Back = drive.actionBuilder(new Pose2d(39, -35, Math.toRadians(180)))
                .strafeToSplineHeading(new Vector2d(48, -30), Math.toRadians(180), new TranslationalVelConstraint(45), new ProfileAccelConstraint(-45, 45))
                .afterDisp(0, new ParallelAction(
                        autoActions.openWideClawR(),
        ...
        goToStage2Cycle = drive.actionBuilder(new Pose2d(-61, -38, Math.toRadians(180)))
                ...
                .splineToConstantHeading(new Vector2d(47.5, -44), Math.toRadians(-45))
                .build();
...
//        Actions.runBlocking(claw.closeClaw());
        ...
        if (conePos == 1) {
            ...
            goToStack = drive.actionBuilder(new Pose2d(-44.5, -35, Math.toRadians(90)))
                    ...
                    .strafeToSplineHeading(new Vector2d(-60, -33), Math.toRadians(180), new TranslationalVelConstraint(20), new ProfileAccelConstraint(-20, 20))
                    .build();
        } else if (conePos == 2) {
            ...
            goToStack = drive.actionBuilder(new Pose2d(-33, -35, Math.toRadians(30)))
                    .strafeTo(new Vector2d(-35, -45))
                    .strafeToSplineHeading(new Vector2d(-50, -33), Math.toRadians(180))
                    .afterDisp(0, new ParallelAction(
                            autoActions.armToStack1(),
